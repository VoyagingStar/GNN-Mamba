...
def get_args():
    ...
    parser.add_argument("--save-dir", default=f"results/{date}_gnn_pred/")
    parser.add_argument(
        "--checkpoint-pth",
...
def predict():
    ...
    common.setup_logger(save_dir, log_name="gnn_pred.log", debug=kwargs["debug"])
    ...
    pred_dataset = gnn_data.MolDataset(
