...
def get_args():
    ...
    parser = add_gnn_train_args(parser)
...
def train_model():
    ...
    common.setup_logger(save_dir, log_name="gnn_train.log", debug=kwargs["debug"])
    ...
    train_dataset = gnn_data.BinnedDataset(
        train_df,
        data_dir=data_dir,
        num_bins=num_bins,
    ...
    val_dataset = gnn_data.BinnedDataset(
        val_df,
        data_dir=data_dir,
        num_bins=num_bins,
        # num_workers=num_workers,
    ...
    test_dataset = gnn_data.BinnedDataset(
        test_df,
        data_dir=data_dir,
        num_bins=num_bins,
        # num_workers=num_workers,
